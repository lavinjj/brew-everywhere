describe('fermentableType', function() {

	beforeEach(module('brew-everywhere'));

	it('should filter by Type', inject(function($filter) {
    var fermentables = [{ "Name":"Acid Malt", "Type":"Grain", "Amount":0.000000, "Yeild": 58.7, "Color": 3.0, "AddAfterBoil": false, "Origin":"Germany", "Supplier": "", "Notes":"Acid malt contains acids from natural lactic acids.  Used by German brewers to adjust malt PH without chemicals to adhere to German purity laws.  Also enhances the head retention. ", "CoarseFineDiff": 1.5, "Moisture": 4.0, "DiastaticPower": 0.0, "Protein": 6.0, "MaxInBatch": 10.0, "RecommendMash": true, "IBUGalPerPound": 0.000, "DisplayAmount": "0.0 oz", "Potential": 1.027, "DisplayColor":  3.0, "ExtractSubstitute": "Pale Liquid Extract"},
    ...
    var expected = $filter('fermentableType')(fermentables, 'Grain');
