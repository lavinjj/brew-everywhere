angular.module('brew-everywhere').directive('uniqueUserName', function(mongolab, constants) {
	return {
    restrict: 'A',
    require: 'ngModel',
    link: function (scope, element, attrs, ctrl) {
      ...
      ctrl.$parsers.unshift(function (viewValue) {
        ...
        if ((viewValue !== null) && (viewValue !== undefined) && (viewValue !== '')) {
          mongolab.query(constants.mongodb.database,  constants.mongodb.brewerCollection, {q: {UserName: viewValue}})
